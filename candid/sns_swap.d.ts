...
export interface GetCanisterStatusResponse { 'canister_cycle_balance' : bigint }
...
export interface RefreshBuyerTokensRequest { 'buyer' : string }
export interface SetModeCallResult { 'possibility' : [] | [Possibility] }
...
export interface Swap { 'init' : [] | [Init], 'state' : [] | [State] }
