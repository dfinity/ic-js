...
export const idlFactory = ({ IDL }) => {
  ...
  const DecentralizationSaleBackgroundInformation = IDL.Record({
  ...
  const DerivedProposalInformation = IDL.Record({
    'decentralization_sale_background_information' : IDL.Opt(
      DecentralizationSaleBackgroundInformation
    ),
  });
  ...
  const OpenSnsDecentralizationSale = IDL.Record({
    'target_decentralization_sale_canister_id' : IDL.Opt(IDL.Principal),
  ...
  const ProposalData = IDL.Record({
    'id' : IDL.Opt(NeuronId),
    'sns_decentralization_sale_lifecycle' : IDL.Opt(IDL.Int32),
  ...
  const SettleCommunityFundParticipation = IDL.Record({
    ...
    'open_sns_decentralization_sale_proposal_id' : IDL.Opt(IDL.Nat64),
  });
