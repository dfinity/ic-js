// TODO: Deduplicate with the file in nns-dapp.  Probably store the data here and export it for use by nns-dapp.
...
export const DEMO_SUMMARY = `# Pedum natura bimembres florem missos protinus
